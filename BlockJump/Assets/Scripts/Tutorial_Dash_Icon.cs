...
public class Tutorial_Dash_Icon : MonoBehaviour
{
    /// <summary>
    ...
    public PlayerMove_Tutorial_Stage playerMove_Tutorial_Stage;// playerMove_Tutorial_Stageのboolを参照
    ...
    void Update()
    {
        ...
        if (dash_Cool_Time == true)// ダッシュをしたかの判定
        {
            ...
            {
                playerMove_Tutorial_Stage.dash = true;// PlayerMoveのdashをtrueにして再度ダッシュ可能にする
    ...
    public void CTuse()
    {
        ...
        playerMove_Tutorial_Stage.dash = false;// ダッシュを一定時間禁止させる
